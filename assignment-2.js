...
function saveObjToLocalStore(obj) {
    // Hamain JSON.Stringify use kr ny ki zaroorat iss liye nhii padi q k (accessKeyOfObject), (accessValueOfObject) hamain array hi return kr ta ha, iss liye hum na direct loop laga k uss ko localstorage ma set kra dya ha.
    var accessKeyOfObject = Object.keys(obj)
    var accessValueOfObject = Object.values(obj)
    // Loop through given object to access key and values & set them in local store.
